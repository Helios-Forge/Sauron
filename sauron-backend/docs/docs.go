    ...
    "definitions": {
        "sauron-backend_internal_models.CompatibilityRule": {
            ...
            "properties": {
                ...
                "constraint_type": {
                    "description": "Type of compatibility constraint (e.g., \"required\", \"optional\", \"incompatible\")",
                    "type": "string",
                    "example": "required"
                },
                "created_at": {
        ...
        "sauron-backend_internal_models.FirearmModel": {
            ...
            "properties": {
                ...
                "compatible_parts": {
                    "description": "List of compatible parts for this firearm model\n@Description JSON array of compatible part categories",
                    "type": "array",
                    "items": {
                        "type": "string"
                    },
                ...
                "required_parts": {
                    "description": "List of required parts for this firearm model\n@Description JSON array of required part names",
                    "type": "array",
                    "items": {
                        "type": "string"
                    },
        ...
        "sauron-backend_internal_models.Part": {
            ...
            "properties": {
                ...
                "compatibility": {
                    "description": "Compatibility information with other parts and models\n@Description JSON object containing compatibility rules",
                    "type": "string",
                ...
                "legal_restrictions": {
                    "description": "Legal restrictions or requirements for this part\n@Description JSON object containing legal restriction details",
                    "type": "string",
        ...
        "sauron-backend_internal_models.PrebuiltFirearm": {
            ...
            "properties": {
                "components": {
                    "description": "List of components included in this build\n@Description JSON object containing component details and specifications",
                    "type": "string",
                    "example": "{\"upper_receiver\":\"BCM Complete Upper\",\"lower_receiver\":\"Aero M4E1\",\"barrel\":\"16 inch 5.56 NATO\"}"
                },
                "created_at": {
                    "description": "Creation timestamp",
                    "type": "string"
        ...
        "sauron-backend_internal_models.UserSuggestion": {
            ...
            "properties": {
                ...
                "suggested_parts": {
                    ...
                    "type": "string",
                    "example": "{\"parts\":[\"Custom Handguard\",\"Modified BCG\"],\"modifications\":[\"Enhanced Feed Ramps\"]}"
                },
                "updated_at": {
                    "description": "Last update timestamp",
                    "type": "string"

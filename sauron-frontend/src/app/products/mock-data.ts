...
export const productsData: Product[] = [
  ...
  {
    id: "bcg-bolt-1",
    name: "Enhanced AR-15 Bolt - Carpenter 158",
    category: "upper-components",
    subCategory: "bolt",
    brand: "bcm",
    compatibility: ["AR-15", "M16", "5.56 NATO", ".223 Rem"],
    ...
    rating: 4.8,
    reviewCount: 156,
    image: "/mock-bolt-1.jpg",
    description: "High-quality Carpenter 158 steel bolt, MPI and HPT tested. Features proper heat treatment and shot peening for enhanced durability.",
    vendors: [
      { id: "brownells", name: "Brownells", price: 69.99, inStock: true, shippingCost: 5.99, link: "#" },
      { id: "primary-arms", name: "Primary Arms", price: 72.99, inStock: true, shippingCost: 4.99, link: "#" },
      { id: "aim-surplus", name: "AIM Surplus", price: 65.99, inStock: true, shippingCost: 6.99, link: "#" }
    ],
    inStock: true
  },
  {
    id: "bcg-firing-pin-1",
    name: "Chrome Plated Firing Pin",
    category: "upper-components",
    subCategory: "firing-pin",
    brand: "daniel-defense",
    ...
    rating: 4.7,
    reviewCount: 89,
    image: "/mock-firing-pin-1.jpg",
    description: "Chrome plated firing pin for enhanced durability and smooth operation. Standard weight for reliable primer strikes.",
    vendors: [
      { id: "palmetto", name: "Palmetto State Armory", price: 19.99, inStock: true, shippingCost: 3.99, link: "#" },
      { id: "brownells", name: "Brownells", price: 21.99, inStock: true, shippingCost: 4.99, link: "#" },
      { id: "midwayusa", name: "Midway USA", price: 18.99, inStock: true, shippingCost: 5.99, link: "#" }
    ],
    inStock: true
  },
  {
    id: "bcg-extractor-1",
    name: "Enhanced Extractor with Spring Upgrade",
    category: "upper-components",
    ...
    specs: {
      "Material": "Tool Steel",
      "Spring": "Enhanced Power",
      "Insert": "Black Insert Installed",
      "O-Ring": "Yes"
    },
    price: 24.99,
    rating: 4.9,
    reviewCount: 127,
    image: "/mock-extractor-1.jpg",
    description: "Enhanced extractor with upgraded spring, black insert, and O-ring for improved reliability and extraction.",
    vendors: [
      { id: "brownells", name: "Brownells", price: 24.99, inStock: true, shippingCost: 3.99, link: "#" },
      { id: "primary-arms", name: "Primary Arms", price: 26.99, inStock: true, shippingCost: 4.99, link: "#" },
      { id: "aim-surplus", name: "AIM Surplus", price: 23.99, inStock: false, shippingCost: 0, link: "#" }
    ],
    inStock: true
  },
  {
    ...
    rating: 4.6,
    reviewCount: 74,
    image: "/mock-cam-pin-1.jpg",
    description: "Mil-spec cam pin manufactured to proper specifications. Heat treated for durability with manganese phosphate finish.",
    vendors: [
      { id: "primary-arms", name: "Primary Arms", price: 9.99, inStock: true, shippingCost: 3.99, link: "#" },
      { id: "brownells", name: "Brownells", price: 11.99, inStock: true, shippingCost: 4.99, link: "#" },
      { id: "palmetto", name: "Palmetto State Armory", price: 8.99, inStock: true, shippingCost: 5.99, link: "#" }
    ],
    inStock: true
  },
  {
    id: "bcg-bolt-carrier-1",
    name: "M16 Full-Auto Profile Bolt Carrier",
    category: "upper-components",
    subCategory: "bolt-carrier",
    brand: "bcm",
    compatibility: ["AR-15", "M16"],
    specs: {
      "Material": "8620 Steel",
    ...
    rating: 4.8,
    reviewCount: 203,
    image: "/mock-bolt-carrier-1.jpg",
    description: "Full-auto profile bolt carrier machined from 8620 steel. Features properly staked gas key and manganese phosphate finish.",
    vendors: [
      { id: "brownells", name: "Brownells", price: 89.99, inStock: true, shippingCost: 0, link: "#" },
      { id: "primary-arms", name: "Primary Arms", price: 94.99, inStock: true, shippingCost: 5.99, link: "#" },
      { id: "aim-surplus", name: "AIM Surplus", price: 87.99, inStock: true, shippingCost: 6.99, link: "#" }
    ],
    inStock: true
  },
  {
    id: "bcg-firing-pin-retaining-pin-1",
    name: "Mil-Spec Firing Pin Retaining Pin",
    category: "upper-components",
    subCategory: "firing-pin-retaining-pin",
    brand: "aero-precision",
    compatibility: ["AR-15", "M16"],
    specs: {
      "Material": "Steel",
      "Type": "Standard Cotter Pin",
      "Finish": "Phosphate",
      "Pack Quantity": "1"
    },
    price: 3.99,
    rating: 4.5,
    reviewCount: 42,
    image: "/mock-retaining-pin-1.jpg",
    description: "Standard mil-spec firing pin retaining pin. Properly sized and finished for reliable retention.",
    vendors: [
      { id: "primary-arms", name: "Primary Arms", price: 3.99, inStock: true, shippingCost: 2.99, link: "#" },
      { id: "brownells", name: "Brownells", price: 4.99, inStock: true, shippingCost: 3.99, link: "#" },
      { id: "palmetto", name: "Palmetto State Armory", price: 3.49, inStock: true, shippingCost: 4.99, link: "#" }
    ],
    inStock: true
  }
];
